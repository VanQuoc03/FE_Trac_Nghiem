...
export default function RegisterTeacher({ onRegister }) {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#FFF0E5] flex items-center justify-center pt-32">
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <input
                type="text"
                value={classTeach}
                onChange={(e) => setClassTeach(e.target.value)}
                className="w-full px-4 py-2 rounded-full bg-white focus:outline-none"
                required
              />
            </div>
